    ...
    return (
        <section className="w-screen h-screen bg-white dark:text-white dark:bg-[#000015]">
            <main className="ml-48 md:ml-64">
                ...
                <ul className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-1 mt-6 lg:mt-10">
                    <li className="pt-4">
                        <FaReact size={70} className="text-[#61DBFB] mx-auto" />
                    ...
                    <li className="pt-4">
                        <FaHtml5 size={70} className="text-[#e34c26] mx-auto" />
                        <h3 className="font-roboto text-xl text-center">
                            HTML 5
                        </h3>
                    </li>
                    ...
                    <li className="pt-4">
                        <DiGit size={70} className="text-[#f34f29] mx-auto" />
                        <h3 className="font-roboto text-xl text-center">
                            Git
                        </h3>
                    </li>
